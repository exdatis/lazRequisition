...
uses
  ...
  ustorageout, ustock, uproductreview;
{$R *.lfm}
...
procedure TfrmMain.acFullHelpExecute(Sender: TObject);
var
  pdfFile : String = 'DetaljnoUputstvo.pdf';
  pathPdfFile : String;
begin
...
procedure TfrmMain.acProductReviewExecute(Sender: TObject);
var
  newForm : TfrmProductReview;
begin
  {close any forms}
  clearOldForms;
  {proveri konekciju sa bazom}
  ...
  try
    {create new}
    newForm:= TfrmProductReview.Create(nil);
    {set dbGrid title images}
    //newForm.setDbGridTitleImages;
    {set parent ctrl}
    newForm.Parent:= formPanel;
...
procedure TfrmMain.acStorageOutExecute(Sender: TObject);
var
  newForm : TfrmStorageOut;
begin
  {close any forms}
  clearOldForms;
  {proveri konekciju sa bazom}
  ...
  try
    {create new}
    newForm:= TfrmStorageOut.Create(nil);
    {set dbGrid title images}
    //newForm.setDbGridTitleImages;
    {set parent ctrl}
    newForm.Parent:= formPanel;
